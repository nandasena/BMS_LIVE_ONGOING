...
export class InvoiceQuotationPrintComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal,private invoiceQuotationService:QuotationService) {
  }
  ...
  showAddMilestoneModal(){
      this.invoiceQuotationService.getInvoiceDetailForReprintById(this.rowData.id).then((response) => {
